...
export const lifestyles: Lifestyle[] = [{
  ...
  outcomes: [{
    ...
    min: 4,
    max: 5,
    description: "Instead of talking your way through situations, you attempt to use your knowledge",
    special: [{
      attributes: ["int"],
      modifier: 2
    }, {
  ...
  outcomes: [{
    min: 1,
    max: 3,
    description: "You’ve grown with religion as a major impactor of your life",
    special: [{
      attributes: ["str"],
      modifier: -3
    }, {
  ...
  outcomes: [{
    min: 1,
    max: 3,
    description: "You isolate yourself, learning you can only depend on your own actions",
    special: [{
      attributes: ["ch"],
      modifier: -3
    }, {
    ...
    min: 4,
    max: 5,
    description: "You’ve become distrustful of others, you look out for yourself",
    special: [{
      attributes: ["ch"],
      modifier: -3
    }, {
  ...
  outcomes: [{
    min: 1,
    max: 2,
    description: "You sold goods, using quick wit to talk people into sales",
    special: [{
      attributes: ["ch"],
      modifier: 3
    }, {
  ...
  outcomes: [{
    ...
    min: 3,
    max: 10,
    description: "You were a member of a Mercenary Team, which took jobs for cash",
    special: [{
      attributes: ["ld"],
      modifier: -3
    }, {
