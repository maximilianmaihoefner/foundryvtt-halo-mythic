...
Hooks.once('ready', async () => {
  ...
  Hooks.on('hotbarDrop', (hotbar, data, slot) =>
    createMythicMacro(hotbar, data, slot)
  );
});

Hooks.on('renderChatLog', (app: any, html: any, data: any) =>
  console.log('renderChatLog: app', app, 'html', html, 'data', data)
);
Hooks.on('getApplicationHeaderButtons', (app: any, buttons: any) =>
  console.log('getApplicationHeaderButtons: app', app, 'buttons', buttons)
);
Hooks.on('renderApplication', (app: any, html: any, data: any) =>
  console.log(
    'getApplicationHeaderButtons: app',
    app,
    'html',
    html,
    'data',
